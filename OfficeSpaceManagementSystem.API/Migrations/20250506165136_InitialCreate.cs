        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeskType = table.Column<int>(type: "INTEGER", nullable: false),
                    Name = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZonePreference = table.Column<int>(type: "INTEGER", nullable: false),
                    DeskTypePref = table.Column<int>(type: "INTEGER", nullable: false),
                    AssignedDeskId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reservations_Desks_AssignedDeskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Desks_ZoneId",
                table: "Desks",
                column: "ZoneId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_AssignedDeskId",
                table: "Reservations",
